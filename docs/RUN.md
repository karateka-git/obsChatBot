...
SQLite persistence chunks появится в 10.2. После её подключения изменение
параметров будет менять index signature и запускать полный rebuild индекса vault.
