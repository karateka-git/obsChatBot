...
Это историческое исследование первой версии. Ограничение Telegram-only ниже
уже пересмотрено: VK, RAG и GitHub write-back реализованы. Текущую систему
описывает [ARCHITECTURE.md](ARCHITECTURE.md), этот документ сохраняет исходное
